...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#f3f6fa] w-full">
      <div className="container flex flex-wrap mx-auto py-12 md-lg:pb-10 sm:pb-6">
      ...
      {/*  */}
      <div className="container flex flex-wrap mx-auto justify-center items-center text-slate-600 pb-5 text-center">
