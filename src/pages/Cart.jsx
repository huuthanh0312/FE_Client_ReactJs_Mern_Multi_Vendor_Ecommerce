                ...
                <div className="pr-3 md-lg:pr-0">
                  <div className="flex flex-col gap-3">
                    <div className="bg-white rounded-md shadow-lg hover:shadow-indigo-200 ">
                      <div className="border-b-2 shadow-md p-4">
                        <h2 className="text-md text-[#34548d] font-semibold inline-flex justify-center items-center gap-2">
                      ...
                      {cartProduct.map((p, i) => (
                        <div
                          key={i}
                          className="flex bg-white p-4 sm:px-2 flex-col gap-2 rounded-b-md"
                        >
                            ...
                            <div key={i} className="w-full flex flex-wrap">
                              <div className="w-full flex gap-4 sm:gap-2 bg-white rounded-md shadow-lg">
                                <div className="flex gap-4 p-2 relative ">
                                  <div className="flex justify-center items-center absolute text-white w-[20px] h-[20px] rounded-full shadow-md bg-red-500 font-semibold text-xs p-2 left-2 top-2">
                                    8%
                                  </div>
                    ...
                    <div className="bg-white rounded-md shadow-lg hover:shadow-indigo-200 ">
                      ...
                      <div className="flex bg-white p-4 sm:px-2 flex-col gap-2 rounded-md">
                        {[1, 2].map((p, i) => (
                          <div key={i} className="w-full flex flex-wrap">
                            <div className="w-full flex gap-4 sm:gap-2 bg-white rounded-md shadow-lg">
                              <div className="flex gap-4 p-2 relative ">
              ...
              <div className="w-[33%] md-lg:w-full">
                <div className="pl-3 md-lg:pl-0 md-lg:mt-5">
                  {cartProduct.length > 0 && (
                    <div className="bg-white font-semibold p-4 text-slate-600 flex flex-col gap-3 rounded-md shadow-lg hover:shadow-indigo-200">
                      ...
                      <button className="w-full inline-flex justify-center items-center gap-2 px-5 py-3 bg-[#34548d] text-white rounded-sm uppercase text-sm shadow-md hover:shadow-blue-200">
